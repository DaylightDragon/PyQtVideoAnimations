...
class Navigation:
    ...
    def on_mousewheel(self, event: QWheelEvent):
        ...
        # print(self.globalPositionData.scale + (event.angleDelta().y() // 120) / 10 * self.data.scrollSensitivity)
        ...
        # print(self.globalPositionData.scale)
    ...
    def notifyMovementListeners(self):
        try:
            for listener in self.data.movementListeners:
                listener.onMovement()
